...
<body>
  <div class="container">
    <div style="display: none; visibility: hidden; overflow: hidden; opacity: 0; color: transparent; height: 0; width: 0; max-height: 0; max-width: 0;">
      Welcome to ONLINE DEMO
    </div>
    <div class="content">
      <p>Hi ${firstName},</p>
      <p>Please use the code below to complete the verification process.</p>
      <div class="otp-box">${otp}</div>
      <p>The code is valid for 10 minutes.</p>
      <p>If you did not request this, you can safely ignore this email.</p>
      <p>Best regards,<br>ONLINE DEMO</p>
    </div>
    <div class="footer">
      <p>Thank you for choosing ONLINE DEMO!</p>
    </div>
  </div>
</body>
</html>
